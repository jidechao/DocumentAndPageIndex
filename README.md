...
PageIndex now supports **Model Context Protocol (MCP)**, enabling seamless integration with AI assistants like Claude Desktop and Cursor. Use PageIndex's reasoning-based RAG directly in your favorite AI tools!
...
- "Search for documents about PageIndex installation"
- "Find information about tree structure generation"

👉 For detailed MCP setup instructions, see [README_MCP.md](./README_MCP.md)
...
- 🔌 Check out [README_MCP.md](./README_MCP.md) for self-hosted MCP server setup and integration with Claude Desktop.
- ⚙️ Refer to the [MCP setup](https://pageindex.ai/mcp#quick-setup) or [API docs](https://docs.pageindex.ai/quickstart) for cloud service integration details and configuration options.
